...
import { termsOfService, companyInfo } from '../data/mockData';

const TermsOfService = () => {
  useEffect(() => {
    document.title = `Terms of Service - ${companyInfo.name}`;
  }, []);
        ...
        <div className="container mx-auto px-6 text-center max-w-4xl">
          ...
          >
            <p className="inline-flex items-center gap-2 text-blue-600 uppercase tracking-widest font-semibold text-sm mb-4">
              <FileCheck2 size={18} />
              Updated {termsOfService.lastUpdated}
            </p>
            <h1 className="text-4xl lg:text-6xl font-bold text-gray-900 mb-6">
              Terms of Service
            </h1>
            <p className="text-xl text-gray-600">
              These terms outline how we collaborate, safeguard deliverables, and protect both parties.
            </p>
          </motion.div>
        </div>
      </section>
